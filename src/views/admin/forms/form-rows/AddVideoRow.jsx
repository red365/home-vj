...
const AddVideoRow = (props) => {
  return (
    <div key={props.id} className="medium-col__admin input-container__admin">
      <Dropdown id={`select-video-${props.video.id}`} name="videoId" classes="" type="Local Video" changeHandler={(e) => props.handleInput(e, props.video.id)} dropdownItems={props.videos} propToUseAsItemText="filename" />
