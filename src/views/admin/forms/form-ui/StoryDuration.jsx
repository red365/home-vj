...
export const StoryDuration = props => {
    const {storyMediaItems, storyDuration, slideshows, localVideos, getNumberOfSlideshowSlides} = props;
    ...
    const getStoryTimeLeftToFillInS = () => {
      const reducedTotal = storyMediaItems.filter(item => item.mediaType != undefined).reduce( reduceStoryItemDuration, 0);
